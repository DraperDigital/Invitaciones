...
const InteractiveMap: React.FC<InteractiveMapProps> = ({ 
    ...
    return (
        <section id="location" className="py-24 bg-white relative overflow-hidden">
            <div className="absolute top-0 left-0 w-64 h-64 bg-[#BD7474]/5 rounded-br-[10rem] -z-0" />
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10">
                ...
                <div className="bg-[#FDFBF7] rounded-[3rem] p-12 md:p-16 border border-stone-100 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.05)] text-center space-y-12">
                    <div className="space-y-4">
                        <div className="inline-flex items-center gap-2 text-[10px] uppercase tracking-[0.3em] font-bold text-[#BD7474]">
                            <MapPin className="h-3 w-3" /> PUNTO DE ENCUENTRO
                        </div>
                        <h3 className="text-3xl md:text-4xl font-serif text-[#1B2E1D]">{venueName}</h3>
                    ...
                    <div className="grid sm:grid-cols-2 gap-6 pt-8">
                        <button 
                            ...
                            className="bg-white hover:bg-stone-50 text-[#1B2E1D] py-6 rounded-2xl flex items-center justify-center gap-3 border border-stone-200 shadow-sm transition-all transform active:scale-[0.98] group"
                        >
