...
export default function ExamplesPage() {
    ...
    const filteredExamples = useMemo(() => {
        const TEMPLATES = [
            ...
            { id: 'romantic-botanical', name: 'Elegancia Floral', category: 'xv', slug: 'xv-regina-2026-premium', plan: 'Premium', thumbnail: 'https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=800&auto=format&fit=crop' },
            { id: 'neon-glow', name: 'Fiesta Neón', category: 'cumpleanos', slug: 'cumple-emilia-premium', plan: 'Premium', thumbnail: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?q=80&w=800&auto=format&fit=crop' },
            ...
            { id: 'floral-symmetry', name: 'Simetría Floral', category: 'boda', slug: 'boda-simetria-floral', plan: 'Premium', thumbnail: 'https://images.unsplash.com/photo-1526047932273-341f2a7631f9?q=80&w=800&auto=format&fit=crop' }
        ];
